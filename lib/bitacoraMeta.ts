...
/** Tipos anteriores al catálogo solicitado. Se conservan para leer y editar
 * registros históricos sin alterar datos ya persistidos. */
export const LEGACY_EVENT_TYPES = ["visita", "incidente", "mantencion"] as const;
...
export const TIPO_LABEL_PERSISTIDO: Record<EventoTipoPersistido, string> = {
  ...TIPO_LABEL,
  visita: "Visita (histórico)",
  incidente: "Incidente (histórico)",
